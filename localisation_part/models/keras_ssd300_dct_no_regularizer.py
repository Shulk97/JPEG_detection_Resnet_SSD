...
def ssd_300DCT_no_reg(image_size,
            n_classes,
            mode='training',
    ...
    conv4_1 = Conv2D(512, (3, 3), activation='relu', padding='same', name='conv4_1')(x)
    ...
    conv7_2 = Conv2D(256, (3, 3), strides=(2, 2), activation='relu', name='conv7_2')(conv7_1)

    conv8_1 = Conv2D(128, (1, 1), activation='relu', padding='same', name='conv8_1')(conv7_2)
    conv8_2 = Conv2D(256, (3, 3), strides=(1, 1), activation='relu', name='conv8_2')(conv8_1)

    conv9_1 = Conv2D(128, (1, 1), activation='relu', padding='same', name='conv9_1')(conv8_2)
    conv9_2 = Conv2D(256, (3, 3), strides=(1, 1), activation='relu', name='conv9_2')(conv9_1)
    ...
    conv4_3_norm_mbox_conf = Conv2D(n_boxes[0] * n_classes, (3, 3), padding='same', name='conv4_3_norm_mbox_conf_{}'.format(n_classes))(conv4_3_norm)
    fc7_mbox_conf = Conv2D(n_boxes[1] * n_classes, (3, 3), padding='same', name='fc7_mbox_conf_{}'.format(n_classes))(fc7)
    conv6_2_mbox_conf = Conv2D(n_boxes[2] * n_classes, (3, 3), padding='same', name='conv6_2_mbox_conf_{}'.format(n_classes))(conv6_2)
    conv7_2_mbox_conf = Conv2D(n_boxes[3] * n_classes, (3, 3), padding='same', name='conv7_2_mbox_conf_{}'.format(n_classes))(conv7_2)
    conv8_2_mbox_conf = Conv2D(n_boxes[4] * n_classes, (3, 3), padding='same', name='conv8_2_mbox_conf_{}'.format(n_classes))(conv8_2)
    conv9_2_mbox_conf = Conv2D(n_boxes[5] * n_classes, (3, 3), padding='same', name='conv9_2_mbox_conf_{}'.format(n_classes))(conv9_2)
