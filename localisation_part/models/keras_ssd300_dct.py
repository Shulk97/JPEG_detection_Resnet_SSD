...
def ssd_300DCT(image_size,
    ...
    x = Conv2D(196, (8, 8), strides=8,
                     activation='relu',
                     padding='same',
                     name='conv1_1_dct')(x)

    conv4_1 = Conv2D(512, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_1')(x)
